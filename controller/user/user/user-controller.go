...
func viewAllUsers(app *config.Env) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		ts, err := template.ParseFiles(util.RolePageRender(app, userRole, "admin/users.html")...)
		if err != nil {
...
func viewAgents(app *config.Env) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		data := PageData{users, name, surname, message, email}
...
func viewUser(app *config.Env) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		data := PageData{name, surname, userToview, userAccount, role, roles, message, email}

		ts, err := template.ParseFiles(util.RolePageRender(app, userRole, "admin/user.html")...)
		if err != nil {
			app.ErrorLog.Println(err.Error())
			return
		}
